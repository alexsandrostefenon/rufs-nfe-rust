...
CREATE TABLE public.camex_ncm (
	ncm integer PRIMARY KEY,
	descricao varchar(2048),
	data_inicio timestamp,
	data_fim timestamp,
	tipo_ato_ini varchar(20),
	numero_ato_ini char(3),
	ano_ato_ini char(4),
	unit varchar(16),
...
CREATE TABLE rufs_customer_template.product (
	...
	weight numeric(9,3) default 1.000,
...
CREATE TABLE rufs_customer_template.barcode (
	barcode varchar(14) PRIMARY KEY CHECK (barcode SIMILAR TO '\d{8,}'), -- GTIN-8, GTIN-12, GTIN-13 ou GTIN-14 (antigos códigos EAN, UPC e DUN-14),
...
-- entrada,saída,fabricação,desmonte,conserto
...
CREATE TABLE rufs_customer_template.request (
	--rufs_group_owner integer references rufs_group_owner NOT NULL,
	id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
	type integer references request_type NOT NULL,--tpNF integer default 1,-- 0=Compra/Entrada; 1=Venda/Saída
...
CREATE TABLE rufs_customer_template.request_nfe ( -- nota fiscal
	...
	--nat_op varchar(60) default 'VENDA',
	...
	--(request.type-1) --tpNF integer default 1,-- 0=Compra/Entrada; 1=Venda/Saída
	--id_dest integer default 1,-- 1=Operação interna; 2=Operação interestadual; 3=Operação com exterior.
	...
	--fin_nfe integer default 1,-- 1=NF-e normal; 2=NF-e complementar; 3=NF-e de ajuste; 4=Devolução de mercadoria.
